...
class MaestrosControllerTest < ActionController::TestCase
  ...
  test "should create maestro" do
    assert_difference('Maestro.count') do
      post :create, maestro: { direccion: @maestro.direccion, edad: @maestro.edad, nombre: @maestro.nombre, salon_id: @maestro.salon_id }
    end
  ...
  test "should update maestro" do
    patch :update, id: @maestro, maestro: { direccion: @maestro.direccion, edad: @maestro.edad, nombre: @maestro.nombre, salon_id: @maestro.salon_id }
    assert_redirected_to maestro_path(assigns(:maestro))
  end
