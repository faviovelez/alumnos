...
class AlumnosControllerTest < ActionController::TestCase
  ...
  test "should create alumno" do
    assert_difference('Alumno.count') do
      post :create, alumno: { direccion: @alumno.direccion, edad: @alumno.edad, nombre: @alumno.nombre, salon_id: @alumno.salon_id }
    end
  ...
  test "should update alumno" do
    patch :update, id: @alumno, alumno: { direccion: @alumno.direccion, edad: @alumno.edad, nombre: @alumno.nombre, salon_id: @alumno.salon_id }
    assert_redirected_to alumno_path(assigns(:alumno))
  end
