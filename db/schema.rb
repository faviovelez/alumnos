...
ActiveRecord::Schema.define(version: 20161125040210) do
  ...
  add_index "alumnos", ["salon_id"], name: "index_alumnos_on_salon_id", using: :btree

  create_table "alumnos_maestros", id: false, force: :cascade do |t|
    t.integer "alumno_id"
  ...
  add_foreign_key "alumnos", "salons"
